...
public class WheelView extends ScrollView {
    ...
    public static final String SELECTED_TEXT_COLOR = "#212121";
    public static final String UNSELECTED_TEXT_COLOR = "#bbbbbb";
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor(SELECTED_TEXT_COLOR));
            } else {
                itemView.setTextColor(Color.parseColor(UNSELECTED_TEXT_COLOR));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            paint.setColor(color);//Color.parseColor("#83cde6"));
